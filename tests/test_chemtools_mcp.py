...
class ChemtoolsMCPTests(unittest.TestCase):
    ...
    def test_tools_list_contains_expected_names(self) -> None:
        ...
        self.assertIn("review_nwchem_followup_outcome", names)
        ...
        self.assertIn("prepare_nwchem_run", names)
        self.assertIn("launch_nwchem_run", names)
        self.assertIn("check_nwchem_run_status", names)
        ...
        self.assertIn("summarize_cube_file", names)
        self.assertIn("diagnose_nwchem_output", names)
        self.assertIn("lint_nwchem_input", names)
        self.assertIn("find_nwchem_restart_assets", names)
        self.assertIn("render_nwchem_basis_from_input", names)
        self.assertIn("check_nwchem_spin_charge_state", names)
        self.assertIn("summarize_nwchem_case", names)
        self.assertIn("review_nwchem_case", names)
        self.assertIn("suggest_nwchem_scf_fix_strategy", names)
        ...
        self.assertIn("suggest_nwchem_state_recovery_strategy", names)
        ...
        self.assertIn("resolve_nwchem_ecp", names)
        self.assertIn("render_nwchem_ecp_from_elements", names)
        self.assertIn("resolve_nwchem_basis_setup", names)
    ...
    def test_initialize(self) -> None:
        ...
        self.assertFalse(should_exit)
        self.assertEqual(response["result"]["serverInfo"]["name"], "chemtools-mcp")
