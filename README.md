...
(40 tools), and **DIRAC** (26 tools: parsers, HDF5 checkpoint reader,
...
launcher, bundled 180-page docs) plus 36 program-generic tools that
auto-detect any of them. Molpro, ORCA, and others planned.
