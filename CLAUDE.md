...
- Current tool count: 173 (97 NWChem-specific + 40 Molcas + 36 generic — generics auto-dispatch via `registry.resolve()` and serve any program; includes `get_server_mode`)
