...
- Current tool count: 200 (97 NWChem + 40 Molcas + 27 DIRAC + 36 generic — generics auto-dispatch via `registry.resolve()` and serve any program; includes `get_server_mode`)
