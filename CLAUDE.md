...
- Current tool count: 189 (97 NWChem + 40 Molcas + 16 DIRAC + 36 generic — generics auto-dispatch via `registry.resolve()` and serve any program; includes `get_server_mode`)
