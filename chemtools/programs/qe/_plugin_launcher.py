"""Prepare guided QE plans from named targets or version 1 profiles."""
...
class _QeLaunchPlanner:
    def prepare_launch(
        ...
        if working_directory != input_file.parent:
            raise ValueError(
                "guided QE execution requires the input directory as the "
                "working directory"
            )
...
QE_LAUNCH_PLANNER = _QeLaunchPlanner()


__all__ = ["QE_LAUNCH_PLANNER"]
