"""Legacy action routing for the low-level NWChem tool surface.

This preserves the existing scientific decision table while those tools remain
available. New guided workflows use application services and backend providers.
"""
...
__all__ = ["build_legacy_next_actions"]
