...
_TOPIC_GUIDES: dict[str, dict[str, Any]] = {
    ...
    "cm_class_workflow": {
        "summary": (
            ...
            "  Step 1. Compute a reference 5f^N atomic checkpoint. The "
            "          chemtools orchestrator defaults to **Pu** (Z=94, "
            "          5f^6) — chemically closest to Cm/Bk and converges "
            "          cleanly with KPSELE in DIRAC 25 (~48 outer iter). "
            "          The CmF.md tutorial used Ce (4f^1 lanthanide) for "
            "          legacy DIRAC 21 compatibility; Ce still works as "
            "          a fallback. Empirically: direct Cm 5f^7 AOC "
            "          oscillates in DIRAC 25's hardcoded 50-iter RELSCF "
            "          cap regardless of .LSHIFT / .DAMPFC / .RESOLVE "
            "          / .KPSELE — Pu is the practical surrogate.\n"
            "          Output: cf.Pu (or cf.Ce) atomic coefficient file.\n\n"
