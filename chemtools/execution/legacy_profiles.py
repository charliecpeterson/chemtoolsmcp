"""Shared conversion helpers for version 1 runner profiles.

Program adapters supply executable details. This module converts the common
resource, hardware, module, installation, direct-command, and Slurm fields.
"""
