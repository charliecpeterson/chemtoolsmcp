...
def register_run(
    ...
    ``program`` tags the run with the producing chemistry program. Older
    database rows may have NULL here; current registration paths pass the
    program explicitly.
    ...
    try:
        ...
        try:
            ...
            if "no such column" not in str(exc).lower():
                raise
            from chemtools.persistence.sqlite import ensure_registry_schema
