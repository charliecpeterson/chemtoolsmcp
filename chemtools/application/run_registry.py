"""Compatibility services for campaigns, workflows, and NWChem input batches.

Run-record persistence lives in ``chemtools.persistence.runs``.
"""
...
from chemtools.persistence.sqlite import connect_registry as _connect
...
def generate_input_batch(
    ...
    for idx, combo in enumerate(combos):
        ...
        # This compatibility operation supports NWChem variation keys, so it
        # resolves only the NWChem drafter and retains a local fallback.
