<!-- Source: https://molcas.gitlab.io/OpenMolcas/sphinx/tutorials/tut_vibrot.html -->
...
[previous](<tut_ffpt.html> "3.3.21. FFPT — A Finite Field Perturbation Program") | [next](<tut_single_aniso.html> "3.3.23. SINGLE_ANISO — A Magnetism of Complexes Program") | [index](<../genindex.html> "General Index")
...
In the Advances Examples the reader will find an overview of the input and output files required by VIBROT and the different uses of the program on the calculation of the electronic states of the \\(C_2\\) molecule. The reader is referred to [Section 4.2.57](<../users.guide/programs/vibrot.html#ug-sec-vibrot>) of the user’s guide for a detailed description of the program.
...
[Get PDF](<../../Manual.pdf>) | [Show Source](<../_sources/tutorials/tut_vibrot.rst.txt>)
