    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "OpenMolcas, DIRAC, GRASP workflow scripts, Quantum ESPRESSO, "
                "and QMCPACK supply guided launch providers. QMCPACK can "
                "prepare an initialization-only --dryrun plan."
            ),
            "annotations": {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "input_file": {
                        "type": "string",
                        "description": (
                            "Path to the chemistry input or GRASP workflow "
                            "script."
                        ),
                    },
                    "molecule_file": {
