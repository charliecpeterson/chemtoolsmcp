...
def tool_definitions() -> list[dict[str, Any]]:
    return [
        ...
        # ------------------------------------------------------------------
        {
            ...
            "description": "Parse a NWChem output file into structured sections. Defaults to tasks section only; pass sections=['tasks','mos','freq','mcscf','population','trajectory'] for full parse.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "output_file": {"type": "string"},
                    ...
                    "include_coefficients": {"type": "boolean", "default": False},
        ...
        },
        {
            ...
            "description": "Return the tail of a NWChem output file for quick inspection.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "output_file": {"type": "string"},
                    "lines": {"type": "integer", "default": 30},
                    "max_characters": {"type": "integer", "default": 4000},
                },
                "required": ["output_file"],
                "additionalProperties": False,
            },
        ...
        # ------------------------------------------------------------------
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "module_settings": {"type": "array", "items": {"type": "string"}},
...
def _handle_extract_nwchem_geometry(arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        pass
    return extract_nwchem_geometry(
        output_path=arguments["output_file"],
        frame=frame_arg,
        input_path=arguments.get("input_file"),
    )
...
def _handle_create_nwchem_input(arguments: dict[str, Any]) -> dict[str, Any]:
    return create_nwchem_input(
        ...
        module_settings=arguments.get("module_settings"),
